...
//       // G4ElectronCapture* ecap = new G4ElectronCapture("Target", 0.0*eV);
...
//   // em_config->SetExtraEmModel("e-","e-_G4MicroElecInelastic",mod,"Target",0.0*eV,100*MeV);
...
//   // mod->SetActivationHighEnergyLimit(20*keV);
...
//   // mod->SetActivationLowEnergyLimit(20*keV);
