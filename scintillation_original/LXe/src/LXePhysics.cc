...
G4_DECLARE_PHYSCONSTR_FACTORY(LXePhysics);

LXePhysics::LXePhysics(G4int ver, const G4String &name) : G4EmStandardPhysics_option4(ver, name)
{}

void LXePhysics::ConstructProcess()
{
...
void LXePhysics::ConstructParticle()
{
    G4EmStandardPhysics_option4::ConstructParticle();
}

LXePhysics::~LXePhysics()
{}