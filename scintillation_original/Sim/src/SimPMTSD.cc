...
//
//
/// \file optical/Sim/src/SimPMTSD.cc
/// \brief Implementation of the SimPMTSD class
//
//
#include "SimPMTSD.hh"
...
SimPMTSD::SimPMTSD(G4String name)
...
void SimPMTSD::SetPmtPositions(const std::vector<G4ThreeVector>& positions)
{
...
void SimPMTSD::Initialize(G4HCofThisEvent* hitsCE){
  fPMTHitCollection = new SimPMTHitsCollection
...
G4bool SimPMTSD::ProcessHits(G4Step* ,G4TouchableHistory* ){
  return false;
}
...
G4bool SimPMTSD::ProcessHits_constStep(const G4Step* aStep,
                                       G4TouchableHistory* ){
  ...
  if (hit == nullptr) {//this pmt wasnt previously hit in this event
    hit = new SimPMTHit(); //so create new hit
...
void SimPMTSD::EndOfEvent(G4HCofThisEvent* ) {}
...
void SimPMTSD::DrawAll() {}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void SimPMTSD::PrintAll() {}
