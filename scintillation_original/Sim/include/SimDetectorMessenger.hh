...
//
//
/// \file optical/Sim/include/SimDetectorMessenger.hh
/// \brief Definition of the SimDetectorMessenger class
//
//
#ifndef SimDetectorMessenger_h
#define SimDetectorMessenger_h 1
...
class SimDetectorMessenger: public G4UImessenger
{
  public:

    SimDetectorMessenger(SimDetectorConstruction*);
    virtual ~SimDetectorMessenger();
 
    virtual void SetNewValue(G4UIcommand*, G4String);
 
  private:

    SimDetectorConstruction*     fSimDetector;
