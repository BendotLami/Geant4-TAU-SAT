...
//
//
/// \file optical/Sim/Sim.cc
/// \brief Main program of the optical/Sim example
//
...
int main(int argc, char** argv)
{
  ...
  G4cout << "===== Sim is started with "
         <<  runManager->GetNumberOfThreads() << " threads =====" << G4endl;
#else
  G4RunManager * runManager = new G4RunManager;
#endif
  SimDetectorConstruction* det = new SimDetectorConstruction();
  ...
  runManager->SetUserInitialization(new SimActionInitialization(det));
